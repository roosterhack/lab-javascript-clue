...
var charactersArray = [mrGreen, profPlum, missScarlet, mrsPeacock, mrMustard];
...
function revealMistery(mistery) {
  ...
  return `${mistery[0].first_name} ${mistery[0].last_name} killed Mr.Boddy using the ${mistery[1].name} in the ${
    mistery[2].name
  }!!!!`;
}
